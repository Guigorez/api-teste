...
import os
from unificar_planilhas_nv import normalize_uf, MESES_ORDEM, COLUNAS_PADRAO

# Novoon map might be different or same. Let's assume standardized. If MAPA_COLUNAS likely exists.
# Wait, I shouldn't guess. I'll read unificar_planilhas_nv.py first.

# I'll cancel this edit and read first.
pass
# --- CONFIGURAÇÃO ---
...
DIRETORIOS = {
    'CONSOLIDADO': os.path.join(BASE_DIR, 'Dados', 'Novoon', 'planilhas limpas'),
    'CONCILIADO':  os.path.join(BASE_DIR, 'Dados', 'Novoon', 'planilhas atom')
}
...
def processar_dataframe(df, nome_tabela):
    ...
    # UNIFICAR PLANILHAS NV nao tem MAPA_COLUNAS exportado, entao assumimos que colunas estao OK ou fazemos basic rename
    # Vamos aplicar um rename basico para camel/title case se necessario? 
    # Melhor nao inventar. Se o consolidate script nao renomeia, aqui tbm nao.
    # Mas garantimos existencia das colunas padrao.
